...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
         ...
         * 
         * @Query(value =
         * "insert into Producto (nombreProducto, descripcion, marca, precio, categoria) values (?1, ?2, ?3, ?4, ?5)"
         * , nativeQuery = true)
         * Producto createProducto(String nombreProducto, String descripcion, String
         * marca, BigDecimal precio,
         * String categoria);
         * 
         ...
         * 
         * @Query(value =
         * "update Producto set nombreProducto = ?1, descripcion = ?2, marca = ?3, precio = ?4, categoria = ?5 where id = ?6"
         * , nativeQuery = true)
